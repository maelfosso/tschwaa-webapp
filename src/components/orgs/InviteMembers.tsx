...
const InviteMembers = ({ orgId }: { orgId: number }) => {
  ...
  return (
    <WithFlowbite>
    <div id="invite-members-drawer" className="fixed top-0 right-0 z-40 h-screen overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabIndex="-1" aria-labelledby="drawer-right-label">
      <form
          ...
          <div className="bg-gray-50 px-4 py-6 sm:px-6">
            <div className="flex items-start justify-between space-x-3">
              ...
              <div className="flex h-7 items-center">
                <button data-modal-hide="invite-members-drawer">
